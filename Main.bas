...
Dim window_style As Long
    ...
    Select Case RunMode
        ...
        Case rmScreenSaver  ' Run as a screen saver.
            ...
            Load frmScreen
            frmScreen.Show
            ShowCursor CBool(GetSetting("FlashSaver", "Option", "ShowCursor", "False"))
